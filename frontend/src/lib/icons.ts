...
export const ICONS = {
  ...
  // Where a pull request stands, read at a glance down the left of the list.
  approved:
  ...
  // Copying a sound's link, and the tick that says it landed on the clipboard.
  ...
  check: 'M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,6.59L21,7Z',
} as const
